    ...
    <footer className="bg-gray-800 text-white py-6">
      <div className="container mx-auto flex flex-col md:flex-row justify-around items-center py-5">
        ...
        <div className="w-full md:w-auto mt-4 md:mt-0">
          ...
          <ul className="text-sm space-y-2">
            <li><a href="/assignments" className="hover:underline">All Assignments</a></li>
            ...
            <li><a href="/submitted-assignments" className="hover:underline">Submitted Assignments</a></li>
          </ul>
        </div>
        
        {/* Social Links Section */}
        <div className="flex justify-end mt-4 md:mt-0 w-full md:w-auto">
          <a href="#" aria-label="Facebook" className="hover:text-blue-600 text-xl mx-2">
            <FaFacebookF />
          </a>
          <a href="#" aria-label="Twitter" className="hover:text-blue-600 text-xl mx-2">
            <FaTwitter />
          </a>
          <a href="#" aria-label="LinkedIn" className="hover:text-blue-600 text-xl mx-2">
            <FaLinkedinIn />
          </a>
          <a href="#" aria-label="GitHub" className="hover:text-blue-600 text-xl mx-2">
            <FaGithub />
          </a>
        </div>
      </div>
